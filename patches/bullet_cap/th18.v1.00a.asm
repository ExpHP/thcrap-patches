...
.replacements:
    ...
    dd 0x424c7a  ; BulletManager::on_tick__body  (iter_next)
    dd 0x429282  ; BulletManager::cancel_radius  (iter_next)
    dd 0x429313  ; BulletManager::cancel_radius  (iter_next)
    ...
    dd 0x438fd7  ; Enemy::ecl_func_set_1_6bs  (iter_next)
    ...
    dd 0x439434  ; Enemy::ecl_func_set_4_ex  (iter_next)
